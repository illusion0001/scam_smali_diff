.class Lcom/sec/android/app/camera/engine/request/StopStitchingCaptureRequest;
...
.method static synthetic lambda$null$0(Lcom/sec/android/app/camera/interfaces/Engine$CaptureEventListener;)V
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/interfaces/Engine$CaptureEventListener;->onCaptureStopped()V
...
.method execute()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/StopStitchingCaptureRequest;->mMakerHolder:Lcom/sec/android/app/camera/engine/request/MakerHolder;
    ...
    :try_start_0
    invoke-interface {v1}, Lcom/samsung/android/camera/core2/MakerInterface;->stopTakePicture()V
    :try_end_0
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/StopStitchingCaptureRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/StopStitchingCaptureRequest;->setNextState(Lcom/sec/android/app/camera/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/request/StopStitchingCaptureRequest;->discard()V
    ...
    :goto_1
    iget-object v0, p0, Lcom/sec/android/app/camera/engine/request/StopStitchingCaptureRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;

    new-instance v1, Lcom/sec/android/app/camera/engine/request/-$$Lambda$StopStitchingCaptureRequest$bXbp7DYYOj2QU6u34F1d2-_4bVo;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/-$$Lambda$StopStitchingCaptureRequest$bXbp7DYYOj2QU6u34F1d2-_4bVo;-><init>(Lcom/sec/android/app/camera/engine/request/StopStitchingCaptureRequest;)V
    ...
    invoke-virtual {p0, v1}, Lcom/sec/android/app/camera/engine/request/StopStitchingCaptureRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
...
.method public synthetic lambda$execute$1$StopStitchingCaptureRequest()V
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/engine/request/StopStitchingCaptureRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;

    invoke-interface {p0}, Lcom/sec/android/app/camera/interfaces/InternalEngine;->getCaptureEventListeners()Ljava/util/List;

    move-result-object p0

    sget-object v0, Lcom/sec/android/app/camera/engine/request/-$$Lambda$StopStitchingCaptureRequest$fhWlSNjiVWAGKdv4X91AmvNZd24;->INSTANCE:Lcom/sec/android/app/camera/engine/request/-$$Lambda$StopStitchingCaptureRequest$fhWlSNjiVWAGKdv4X91AmvNZd24;
