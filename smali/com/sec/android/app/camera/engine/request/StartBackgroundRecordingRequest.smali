.class Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;
.super Lcom/sec/android/app/camera/engine/request/Request;
.source "StartBackgroundRecordingRequest.java"
...
.method execute()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/request/-$$Lambda$StartBackgroundRecordingRequest$Tzr7DGtw0cl8uO-xNH-eHAltud4;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/-$$Lambda$StartBackgroundRecordingRequest$Tzr7DGtw0cl8uO-xNH-eHAltud4;-><init>(Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;)V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;->setNextState(Lcom/sec/android/app/camera/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;->discard()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    iget-object p0, p0, Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/request/-$$Lambda$StartBackgroundRecordingRequest$QLtYnUQhxNprMVFfBzrs9MRdGDs;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/-$$Lambda$StartBackgroundRecordingRequest$QLtYnUQhxNprMVFfBzrs9MRdGDs;-><init>(Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;)V
...
.method public synthetic lambda$execute$0$StartBackgroundRecordingRequest()V
    .locals 1
    ...
    invoke-interface {p0, v0}, Lcom/sec/android/app/camera/interfaces/InternalEngine$RecordingEventListener;->onRecordingFailed(I)V

    return-void
.end method

.method public synthetic lambda$execute$1$StartBackgroundRecordingRequest()V
    .locals 0
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/interfaces/InternalEngine$RecordingEventListener;->onRecordingStarted()V
