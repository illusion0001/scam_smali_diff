.class Lcom/sec/android/app/camera/engine/request/CancelTakePictureRequest;
.super Lcom/sec/android/app/camera/engine/request/Request;
.source "CancelTakePictureRequest.java"
...
.method execute()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/CancelTakePictureRequest;->mMakerHolder:Lcom/sec/android/app/camera/engine/request/MakerHolder;
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/CancelTakePictureRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/CancelTakePictureRequest;->setNextState(Lcom/sec/android/app/camera/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/request/CancelTakePictureRequest;->discard()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/engine/request/CancelTakePictureRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelTakePictureRequest$FZS-BpXBZLQzpjyTCTI7bd5JEtQ;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelTakePictureRequest$FZS-BpXBZLQzpjyTCTI7bd5JEtQ;-><init>(Lcom/sec/android/app/camera/engine/request/CancelTakePictureRequest;)V
    ...
    invoke-virtual {p0, v1}, Lcom/sec/android/app/camera/engine/request/CancelTakePictureRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
...
.method public synthetic lambda$execute$1$CancelTakePictureRequest()V
    .locals 1

    iget-object p0, p0, Lcom/sec/android/app/camera/engine/request/CancelTakePictureRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;

    invoke-interface {p0}, Lcom/sec/android/app/camera/interfaces/InternalEngine;->getCaptureEventListeners()Ljava/util/List;

    move-result-object p0

    sget-object v0, Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelTakePictureRequest$lhndUrQLAWFwsx5tPyDY0FlC6LE;->INSTANCE:Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelTakePictureRequest$lhndUrQLAWFwsx5tPyDY0FlC6LE;
