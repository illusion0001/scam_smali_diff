.class Lcom/sec/android/app/camera/engine/request/StartSuperSlowMotionRecordingRequest;
...
.method constructor <init>(Lcom/sec/android/app/camera/engine/request/MakerHolder;Lcom/sec/android/app/camera/interfaces/InternalEngine;Lcom/sec/android/app/camera/engine/request/RequestId;I)V
    ...
    iput p4, p0, Lcom/sec/android/app/camera/engine/request/StartSuperSlowMotionRecordingRequest;->mDetectionType:I
...
.method execute()V
    ...
    iget v1, p0, Lcom/sec/android/app/camera/engine/request/StartSuperSlowMotionRecordingRequest;->mDetectionType:I

    if-nez v1, :cond_0

    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/StartSuperSlowMotionRecordingRequest;->mMakerHolder:Lcom/sec/android/app/camera/engine/request/MakerHolder;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/engine/request/StartSuperSlowMotionRecordingRequest;->mMakerHolder:Lcom/sec/android/app/camera/engine/request/MakerHolder;
    ...
    :try_start_0
    sget-object v3, Lcom/samsung/android/camera/core2/MakerPublicKey;->SEM_REQUEST_CONTROL_SUPER_SLOW_MOTION_MODE:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/StartSuperSlowMotionRecordingRequest;->setNextState(Lcom/sec/android/app/camera/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/request/StartSuperSlowMotionRecordingRequest;->discard()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/engine/request/StartSuperSlowMotionRecordingRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/StartSuperSlowMotionRecordingRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
