.class Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;
...
.method execute()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;

    invoke-interface {v1}, Lcom/sec/android/app/camera/interfaces/InternalEngine;->isEffectProcessorRequired()Z
    ...
    invoke-interface {v1}, Lcom/sec/android/app/camera/interfaces/InternalEngine;->takeEffectPreviewSnapshot()V

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;->mMakerHolder:Lcom/sec/android/app/camera/engine/request/MakerHolder;
    ...
    invoke-interface {v1}, Lcom/samsung/android/camera/core2/MakerInterface;->takePreviewSnapShot()V
    :try_end_0
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;->setNextState(Lcom/sec/android/app/camera/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;->discard()V
