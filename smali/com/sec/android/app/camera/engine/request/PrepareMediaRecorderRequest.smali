...
.method execute()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/sec/android/app/camera/engine/request/PrepareMediaRecorderRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    invoke-interface {v0}, Lcom/sec/android/app/camera/interfaces/RecordingManager;->prepareMediaRecorder()V
    :try_end_0
    .catch Lcom/sec/android/app/camera/exception/MediaRecorderPrepareException; {:try_start_0 .. :try_end_0} :catch_0

    iget-object p0, p0, Lcom/sec/android/app/camera/engine/request/PrepareMediaRecorderRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    const-string v2, "prepare media recorder request failed : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0}, Lcom/sec/android/app/camera/exception/MediaRecorderPrepareException;->getMessage()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/camera/exception/MediaRecorderPrepareException;->getReason()I
    ...
    :goto_0
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/PrepareMediaRecorderRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    invoke-interface {v1, v0}, Lcom/sec/android/app/camera/interfaces/InternalEngine$RecordingEventListener;->onRecordingFailed(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/PrepareMediaRecorderRequest;->setNextState(Lcom/sec/android/app/camera/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/request/PrepareMediaRecorderRequest;->discard()V
