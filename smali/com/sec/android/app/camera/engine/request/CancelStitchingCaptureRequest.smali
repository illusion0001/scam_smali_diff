.class Lcom/sec/android/app/camera/engine/request/CancelStitchingCaptureRequest;
.super Lcom/sec/android/app/camera/engine/request/Request;
.source "CancelStitchingCaptureRequest.java"
...
.method execute()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/CancelStitchingCaptureRequest;->mMakerHolder:Lcom/sec/android/app/camera/engine/request/MakerHolder;
    ...
    :try_start_0
    invoke-interface {v1}, Lcom/samsung/android/camera/core2/MakerInterface;->cancelTakePicture()V
    :try_end_0
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/CancelStitchingCaptureRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/CancelStitchingCaptureRequest;->setNextState(Lcom/sec/android/app/camera/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/request/CancelStitchingCaptureRequest;->discard()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/engine/request/CancelStitchingCaptureRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelStitchingCaptureRequest$uDOf57Uxq3A5iHiOL74bFmlz1Fk;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelStitchingCaptureRequest$uDOf57Uxq3A5iHiOL74bFmlz1Fk;-><init>(Lcom/sec/android/app/camera/engine/request/CancelStitchingCaptureRequest;)V
    ...
    invoke-virtual {p0, v1}, Lcom/sec/android/app/camera/engine/request/CancelStitchingCaptureRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
...
.method public synthetic lambda$execute$1$CancelStitchingCaptureRequest()V
    .locals 1

    iget-object p0, p0, Lcom/sec/android/app/camera/engine/request/CancelStitchingCaptureRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;

    invoke-interface {p0}, Lcom/sec/android/app/camera/interfaces/InternalEngine;->getCaptureEventListeners()Ljava/util/List;

    move-result-object p0

    sget-object v0, Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelStitchingCaptureRequest$ZPB0I-Ikgx5ekpAY_TekK70VY84;->INSTANCE:Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelStitchingCaptureRequest$ZPB0I-Ikgx5ekpAY_TekK70VY84;
