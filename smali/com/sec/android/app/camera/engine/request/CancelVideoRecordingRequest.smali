...
.method execute()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/CancelVideoRecordingRequest;->mMakerHolder:Lcom/sec/android/app/camera/engine/request/MakerHolder;
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/engine/request/CancelVideoRecordingRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;

    new-instance v1, Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelVideoRecordingRequest$gG634ZPqSKz-Pvhgd3q3bqu5ce0;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelVideoRecordingRequest$gG634ZPqSKz-Pvhgd3q3bqu5ce0;-><init>(Lcom/sec/android/app/camera/engine/request/CancelVideoRecordingRequest;)V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/CancelVideoRecordingRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/CancelVideoRecordingRequest;->setNextState(Lcom/sec/android/app/camera/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/request/CancelVideoRecordingRequest;->discard()V
    :try_end_1
    ...
    :goto_1
    iget-object p0, p0, Lcom/sec/android/app/camera/engine/request/CancelVideoRecordingRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    :goto_2
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/CancelVideoRecordingRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;

    new-instance v2, Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelVideoRecordingRequest$gG634ZPqSKz-Pvhgd3q3bqu5ce0;

    invoke-direct {v2, p0}, Lcom/sec/android/app/camera/engine/request/-$$Lambda$CancelVideoRecordingRequest$gG634ZPqSKz-Pvhgd3q3bqu5ce0;-><init>(Lcom/sec/android/app/camera/engine/request/CancelVideoRecordingRequest;)V
    ...
    invoke-virtual {p0, v1}, Lcom/sec/android/app/camera/engine/request/CancelVideoRecordingRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
