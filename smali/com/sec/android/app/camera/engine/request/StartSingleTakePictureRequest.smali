.class Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;
.super Lcom/sec/android/app/camera/engine/request/Request;
.source "StartSingleTakePictureRequest.java"
...
.method constructor <init>(Lcom/sec/android/app/camera/engine/request/MakerHolder;Lcom/sec/android/app/camera/interfaces/InternalEngine;Lcom/sec/android/app/camera/engine/request/RequestId;Lcom/samsung/android/camera/core2/container/DynamicShotInfo;)V
    ...
    iput-object p4, p0, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->mDynamicShotInfo:Lcom/samsung/android/camera/core2/container/DynamicShotInfo;

    iget-object p0, p0, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
...
.method execute()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->mMakerHolder:Lcom/sec/android/app/camera/engine/request/MakerHolder;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->mMakerHolder:Lcom/sec/android/app/camera/engine/request/MakerHolder;
    ...
    iget-object v3, p0, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    iget-object v4, p0, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->mMakerHolder:Lcom/sec/android/app/camera/engine/request/MakerHolder;
    ...
    iget-object v4, p0, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->mDynamicShotInfo:Lcom/samsung/android/camera/core2/container/DynamicShotInfo;
    ...
    sget v4, Lcom/samsung/android/camera/feature/Feature;->SINGLE_TAKE_CAPTURE_DELAY:I

    invoke-interface {v1, v2, v3, v4}, Lcom/samsung/android/camera/core2/MakerInterface;->takeSingleTakePicture(Lcom/samsung/android/camera/core2/container/DynamicShotInfo;Ljava/io/File;I)V
    :try_end_0
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;

    new-instance v1, Lcom/sec/android/app/camera/engine/request/-$$Lambda$StartSingleTakePictureRequest$vVtSqoPGgrSw-xi7L3rLCJKtmiY;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/-$$Lambda$StartSingleTakePictureRequest$vVtSqoPGgrSw-xi7L3rLCJKtmiY;-><init>(Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;)V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->setNextCaptureState(Lcom/sec/android/app/camera/interfaces/Engine$CaptureState;)V
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->setNextState(Lcom/sec/android/app/camera/interfaces/Engine$State;)V

    invoke-virtual {p0}, Lcom/sec/android/app/camera/engine/request/StartSingleTakePictureRequest;->discard()V
...
.method public synthetic lambda$execute$1$StartSingleTakePictureRequest()V
    .locals 1
    ...
    sget-object v0, Lcom/sec/android/app/camera/engine/request/-$$Lambda$StartSingleTakePictureRequest$yBSIJPema6LOIdCoEOQGEtnpVXE;->INSTANCE:Lcom/sec/android/app/camera/engine/request/-$$Lambda$StartSingleTakePictureRequest$yBSIJPema6LOIdCoEOQGEtnpVXE;
