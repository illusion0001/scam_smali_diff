.class synthetic Lcom/sec/android/app/camera/shootingmode/SelfieFocus$3;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sec/android/app/camera/shootingmode/SelfieFocus$3;->$SwitchMap$com$sec$android$app$camera$interfaces$ShootingMode$TimerEvent:[I

    const/4 v0, 0x1

    :try_start_0
    sget-object v1, Lcom/sec/android/app/camera/shootingmode/SelfieFocus$3;->$SwitchMap$com$sec$android$app$camera$interfaces$ShootingMode$TimerEvent:[I
    ...
    :try_start_1
    sget-object v2, Lcom/sec/android/app/camera/shootingmode/SelfieFocus$3;->$SwitchMap$com$sec$android$app$camera$interfaces$ShootingMode$TimerEvent:[I
    ...
    sput-object v2, Lcom/sec/android/app/camera/shootingmode/SelfieFocus$3;->$SwitchMap$com$sec$android$app$camera$interfaces$MenuManager$MenuId:[I

    :try_start_3
    sget-object v2, Lcom/sec/android/app/camera/shootingmode/SelfieFocus$3;->$SwitchMap$com$sec$android$app$camera$interfaces$MenuManager$MenuId:[I

    sget-object v3, Lcom/sec/android/app/camera/interfaces/MenuManager$MenuId;->SELFIE_FOCUS_BEAUTY:Lcom/sec/android/app/camera/interfaces/MenuManager$MenuId;
    ...
    sput-object v2, Lcom/sec/android/app/camera/shootingmode/SelfieFocus$3;->$SwitchMap$com$sec$android$app$camera$interfaces$ShootingMode$CaptureEvent:[I

    :try_start_4
    sget-object v2, Lcom/sec/android/app/camera/shootingmode/SelfieFocus$3;->$SwitchMap$com$sec$android$app$camera$interfaces$ShootingMode$CaptureEvent:[I
    ...
    sput-object v2, Lcom/sec/android/app/camera/shootingmode/SelfieFocus$3;->$SwitchMap$com$sec$android$app$camera$interfaces$CameraSettingsBase$Key:[I

    :try_start_6
    sget-object v2, Lcom/sec/android/app/camera/shootingmode/SelfieFocus$3;->$SwitchMap$com$sec$android$app$camera$interfaces$CameraSettingsBase$Key:[I

    sget-object v3, Lcom/sec/android/app/camera/interfaces/CameraSettingsBase$Key;->SINGLE_BOKEH_EFFECT_TYPE:Lcom/sec/android/app/camera/interfaces/CameraSettingsBase$Key;
