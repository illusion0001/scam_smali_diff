.class synthetic Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;->$SwitchMap$com$sec$android$app$camera$interfaces$RecordingManager$RecordingCommand:[I

    const/4 v0, 0x1

    :try_start_0
    sget-object v1, Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;->$SwitchMap$com$sec$android$app$camera$interfaces$RecordingManager$RecordingCommand:[I
    ...
    :try_start_1
    sget-object v2, Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;->$SwitchMap$com$sec$android$app$camera$interfaces$RecordingManager$RecordingCommand:[I
    ...
    :try_start_2
    sget-object v3, Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;->$SwitchMap$com$sec$android$app$camera$interfaces$RecordingManager$RecordingCommand:[I
    ...
    sput-object v3, Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;->$SwitchMap$com$sec$android$app$camera$interfaces$ShootingMode$TimerEvent:[I

    :try_start_4
    sget-object v3, Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;->$SwitchMap$com$sec$android$app$camera$interfaces$ShootingMode$TimerEvent:[I
    ...
    sput-object v3, Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;->$SwitchMap$com$sec$android$app$camera$interfaces$RecordingManager$RecordingEvent:[I

    :try_start_7
    sget-object v3, Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;->$SwitchMap$com$sec$android$app$camera$interfaces$RecordingManager$RecordingEvent:[I
    ...
    sput-object v3, Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;->$SwitchMap$com$sec$android$app$camera$interfaces$CameraSettingsBase$Key:[I

    :try_start_a
    sget-object v3, Lcom/sec/android/app/camera/shootingmode/SuperSlowMotion$3;->$SwitchMap$com$sec$android$app$camera$interfaces$CameraSettingsBase$Key:[I

    sget-object v4, Lcom/sec/android/app/camera/interfaces/CameraSettingsBase$Key;->SUPER_SLOW_MOTION_FRC_AUTO_CHANGE:Lcom/sec/android/app/camera/interfaces/CameraSettingsBase$Key;
    ...
    sget-object v3, Lcom/sec/android/app/camera/interfaces/CameraSettingsBase$Key;->SUPER_SLOW_MOTION_FRAME_RATE_CONTROL:Lcom/sec/android/app/camera/interfaces/CameraSettingsBase$Key;
